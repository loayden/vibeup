  ...
  return (
    <>
      ...
      <div className="relative bg-[#080808] text-white overflow-x-hidden min-h-screen">
        ...
        ══════════════════════════════════════ */}
        <section className="relative z-10 py-28 px-6 sm:px-12">
          <SectionHeader eyebrow="What We Do" title="VibeUp" gold="Services" />
              ...
              <motion.div key={service.title}
                ...
                <GlassCard className="p-7 h-full">
                  <div className="flex items-center gap-3 mb-5">
                    <span style={{ color:"rgba(198,169,98,0.5)", fontFamily:"'Cormorant Garamond',serif", fontSize:"1rem" }}>✦</span>
                    <h3 className="font-light text-white/85"
                        style={{ fontFamily:"'Cormorant Garamond',serif", fontSize:"1.1rem", letterSpacing:"0.06em" }}>
                      {service.title}
                    </h3>
                  </div>
                  <div className="mb-4 w-full h-px" style={{ background:"rgba(255,255,255,0.06)" }} />
                  <ul className="space-y-2.5">
                    {service.items.map((item) => (
                      <li key={item} className="flex items-start gap-3">
                        <Check className="mt-0.5 w-3 h-3 flex-shrink-0" style={{ color:"rgba(198,169,98,0.6)" }} />
                        <span className="text-white/40 font-light text-sm leading-relaxed"
          ...
          >
            <GlassCard className="p-8" gold>
              <p className="text-white/20 text-[9px] tracking-[0.45em] uppercase mb-5"
                 style={{ fontFamily:"'Jost',sans-serif" }}>Optional Add-Ons</p>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {["VIP and hospitality services","Catering and food vendor coordination","Custom décor and luxury event styling","Corporate and brand activations"].map((item) => (
                  <div key={item} className="flex items-start gap-3">
                    <Check className="mt-0.5 w-3 h-3 flex-shrink-0" style={{ color:"rgba(198,169,98,0.7)" }} />
                    <span className="text-white/50 font-light text-sm" style={{ fontFamily:"'Jost',sans-serif", letterSpacing:"0.04em" }}>
                      {item}
                    </span>
                  </div>
                ))}
          ...
          <div className="text-center mt-12">
            <Link href="/services"
              className="inline-flex items-center gap-3 px-9 py-4 rounded-full text-[#C6A962] text-[10px] font-light tracking-[0.3em] uppercase transition-all duration-500 hover:scale-[1.02]"
              style={{
                background:"linear-gradient(135deg, rgba(198,169,98,0.18), rgba(198,169,98,0.06))",
                backdropFilter:"blur(16px)",
                border:"1px solid rgba(198,169,98,0.28)",
