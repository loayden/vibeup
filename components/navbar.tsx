      ...
      <div className="mx-auto max-w-6xl px-6 py-4">
        <div className="flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <Link href="/upcoming-events" className="text-neutral-300 hover:text-amber-400 transition font-semibold">
              Memories
            </Link>
            <Link href="/about" className="text-neutral-300 hover:text-amber-400 transition font-semibold">
              Upcoming event
            </Link>
            <Link href="/contact-us" className="text-neutral-300 hover:text-amber-400 transition font-semibold">
              Contact
            </Link>
            <Link 
              href="/checkout" 
